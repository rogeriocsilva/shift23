    ...
    <div className="flex items-center flex-col gap-6 m-4">
        ...
        <>
          <div className="lg:flex lg:items-center lg:justify-between">
            <p className="mt-2 flex items-center text-sm text-gray-500">
              Get started by generating a new image from a generated prompt.
            </p>
          </div>
        </>
      )}
      <div className="mt-5 flex flex-col items-center lg:ml-4 lg:mt-0">
        <div className="flex gap-2">
          ...
          {response && <MintNFT imageURL={imageURL} />}
        </div>
        {response && (
          <>
            <div className="text-md font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight mt-12">
              {response}
            </div>
            <GenerateImage
              prompt={response}
